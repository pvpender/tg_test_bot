...
async def rul(message: types.message):
 ...
 if (a>900) & (a<1000):
  ...
  await message.answer('Хах! Вы выбили необычную письку 🧻"Ценный ресурс"🧻')
 elif (a>118) & (a<121):
  await message.answer('Ох! Вы выбили особенную письку 🏳‍🌈"Трубочист"🏳‍🌈')
 elif (a>111) & (a<117):
  await message.answer('Ох! Вы выбили мифич. письку ❓"Хто я?"❓')
 elif (a>100) & (a<110):
  await message.answer('Ох! Вы выбили письку победителя конкурса 🇦🇶"Пингвин Дениска ебать"🇦🇶')
 else:
